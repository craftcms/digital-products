...
Craft.DigitalProducts.ProductIndex = Craft.BaseElementIndex.extend({
  ...
  afterInit: function() {
    ...
    for (var i = 0; i < Craft.DigitalProducts.editableProductTypes.length; i++) {
      var productType = Craft.DigitalProducts.editableProductTypes[i];
  ...
  _getProductTypeTriggerHref: function(productType) {
    if (this.settings.context === 'index') {
      var uri = 'digital-products/products/' + productType.handle + '/new';
  ...
  _openCreateProductModal: function(productTypeId) {
    ...
    Craft.createElementEditor(this.elementType, {
      ...
      elementType: 'craft\\digitalproducts\\elements\\Product',
      siteId: this.siteId,
      attributes: {
...
// Register it!
Craft.registerElementIndexClass('craft\\digitalproducts\\elements\\Product', Craft.DigitalProducts.ProductIndex);
